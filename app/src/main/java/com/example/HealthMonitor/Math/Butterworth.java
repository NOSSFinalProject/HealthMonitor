 ...
 */
public class Butterworth extends com.example.HealthMonitor.Math.Cascade {

    class AnalogLowPass extends com.example.HealthMonitor.Math.LayoutBase {
    ...
    private void setupLowPass(int order, double sampleRate,
        ...
        com.example.HealthMonitor.Math.LayoutBase m_digitalProto = new com.example.HealthMonitor.Math.LayoutBase(order);

        new com.example.HealthMonitor.Math.LowPassTransform(cutoffFrequency / sampleRate, m_digitalProto,
                m_analogProto);
    ...
    public void lowPass(int order, double sampleRate, double cutoffFrequency) {
        setupLowPass(order, sampleRate, cutoffFrequency,
                com.example.HealthMonitor.Math.DirectFormAbstract.DIRECT_FORM_II);
    }
    ...
    private void setupHighPass(int order, double sampleRate,
        ...
        new com.example.HealthMonitor.Math.HighPassTransform(cutoffFrequency / sampleRate, m_digitalProto,
                m_analogProto);
    ...
    private void setupBandStop(int order, double sampleRate,
        ...
        com.example.HealthMonitor.Math.LayoutBase m_digitalProto = new com.example.HealthMonitor.Math.LayoutBase(order * 2);

        new com.example.HealthMonitor.Math.BandStopTransform(centerFrequency / sampleRate, widthFrequency
    ...
    private void setupBandPass(int order, double sampleRate,
        ...
        new com.example.HealthMonitor.Math.BandPassTransform(centerFrequency / sampleRate, widthFrequency
                / sampleRate, m_digitalProto, m_analogProto);
