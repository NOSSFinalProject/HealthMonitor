...
public class Biquad {
    ...
    public Complex response(double normalizedFrequency) {
        ...
        ct = com.example.HealthMonitor.Math.MathSupplement.addmul(ct, b1 / a0, czn1);
        ct = com.example.HealthMonitor.Math.MathSupplement.addmul(ct, b2 / a0, czn2);
        cb = com.example.HealthMonitor.Math.MathSupplement.addmul(cb, a1 / a0, czn1);
        cb = com.example.HealthMonitor.Math.MathSupplement.addmul(cb, a2 / a0, czn2);
        ch = ch.multiply(ct);
    ...
    public void setPoleZeroForm(com.example.HealthMonitor.Math.BiquadPoleState bps) {
        setPoleZeroPair(bps);
        applyScale(bps.gain);
    }
    ...
    public void setPoleZeroPair(com.example.HealthMonitor.Math.PoleZeroPair pair) {
