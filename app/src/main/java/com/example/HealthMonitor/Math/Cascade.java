...
public class Cascade {
    ...
    public void setLayout(com.example.HealthMonitor.Math.LayoutBase proto, int filterTypes) {
        ...
        switch (filterTypes) {
            case DirectFormAbstract.DIRECT_FORM_I:
                m_states = new com.example.HealthMonitor.Math.DirectFormI[m_numBiquads];
                for (int i = 0; i < m_numBiquads; i++) {
                    m_states[i] = new com.example.HealthMonitor.Math.DirectFormI();
                }
                break;
