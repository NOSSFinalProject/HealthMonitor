package com.example.HealthMonitor.net.simplyadvanced.vitalsigns.setting;
...
public class UserStatsSettingsActivity extends Activity implements AdapterView.OnItemSelectedListener {
    private EditText mEditTextAge, editTextSex, editTextWeight, editTextHeight;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_stats_settings);
