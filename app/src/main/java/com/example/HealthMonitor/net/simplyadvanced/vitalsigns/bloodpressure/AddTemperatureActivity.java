package com.example.HealthMonitor.net.simplyadvanced.vitalsigns.bloodpressure;
...
import com.example.HealthMonitor.net.simplyadvanced.vitalsigns.util.ConnectivityUtils;
import com.example.HealthMonitor.net.simplyadvanced.vitalsigns.util.RSSHandler;
...
public class AddTemperatureActivity extends Activity {
    ...
    private EditText mEditTextSkinTemperature, mEditTextIndoorTemperature;
    private TextView mTextViewSkinTemperature, mTextViewIndoorTemperature, mTextViewOutdoorTemperature;
    private SharedPreferences settings;
    private int outdoorTemperature = 75;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "lat,long = " + lat + "," + lon, Toast.LENGTH_LONG).show(); // DEBUG
