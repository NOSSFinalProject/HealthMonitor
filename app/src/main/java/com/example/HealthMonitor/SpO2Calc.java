...
public class SpO2Calc extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_o2_calc);
    ...
    private final Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (o2 != 0) {
                Intent i = new Intent(SpO2Calc.this, SpO2Res.class);
                i.putExtra("O2R", o2);
                i.putExtra("Usr", user);
                startActivity(i);
                finish();
    ...
    private final SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            try {
                ...
                Log.e("PreDemosurfaceCallback", "Exception in setPreviewDisplay()", t);
            }
        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(SpO2Calc.this, StartVitalSigns.class);
        i.putExtra("Usr", user);
        startActivity(i);
        finish();
    }
