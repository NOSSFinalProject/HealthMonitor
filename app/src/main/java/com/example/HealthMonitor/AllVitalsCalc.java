...
import com.example.HealthMonitor.Math.Fft2;
...
public class AllVitalsCalc extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_vitals_calc);
    ...
    private final Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if ((Beats != 0) && (o2 != 0) && (Breath != 0)) {
                Intent i = new Intent(AllVitalsCalc.this, AllVitalsRes.class);
                i.putExtra("O2R", o2);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(AllVitalsCalc.this, StartVitalSigns.class);
        i.putExtra("Usr", user);
        startActivity(i);
        finish();
    }
