...
public class Signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,R.array.Genderss, android.R.layout.simple_spinner_item);
        ...
        Log.setOnClickListener(v -> {
            ...
            if (emailInput.isEmpty()) {
                ...
                if (!Patterns.EMAIL_ADDRESS.matcher(emailInput).matches()) {
                    check1 = 1;
                    mainToast = Toast.makeText(getApplicationContext(), "Email Verification failed!", Toast.LENGTH_SHORT);
                    mainToast.show();
            ...
            if (ageStr.isEmpty() || nameStr.isEmpty() || heightStr.isEmpty() || weightStr.isEmpty() || passStr.isEmpty() || passConStr.isEmpty() || emailStr.isEmpty() || usrStr.isEmpty()) {
                ...
                mainToast = Toast.makeText(getApplicationContext(), "success!", Toast.LENGTH_SHORT);
                mainToast.show();
                check1 = 0;
                ...
                per.setgender(k);
                Data.addUser(per);
                Intent intent = new Intent(getApplicationContext(),HMLogin.class);
